  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="font-heading text-3xl font-bold text-gradient-gold">Event Management</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {events.length === 0 && (
          <div className="md:col-span-3 bg-card p-8 rounded-lg border border-gold text-center text-muted-foreground">No events yet</div>
        )}
      </div>
    </div>
  );
