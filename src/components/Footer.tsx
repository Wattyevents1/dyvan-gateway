      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a href="https://www.tiktok.com/@dyvanlounge1" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
            ...
            <a href="https://wa.me/256704240261" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
